...
- UI-facing product projections derived from runtime and account state

## Architecture boundary

`bloop-control-plane` is a separate service/repository.

It is responsible for:
- durable product-facing state
- customer/admin API responses used by `bloop-frontend`
- onboarding, verification, and audit-relevant records
- integration seams for runtime truth reported by `bloop-tunnel`
